...
(async () => {
  ...
  await page.goto('https://8080-aacdadadbfbdedcebfeeecdcaceefaffcabd.ide.exam.ly');
  ...
  await page1.goto('https://8081-aacdadadbfbdedcebfeeecdcaceefaffcabd.ide.exam.ly');
